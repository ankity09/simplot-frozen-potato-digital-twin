    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            cursor.execute(f"""
                WITH latest_sensor_triples AS (
                    ...
                    WHERE p IN (
                        ...
                        'http://example.com/potato-factory/pred/moisture_content',
                        'http://example.com/potato-factory/pred/product_weight'
                    )
            ...
            return jsonify({
                ...
                "status": "success",
                "mapping": {
                    "sensorAReading": "oil_temperature",
                    "sensorBReading": "water_temperature",
                    "sensorCReading": "belt_speed",
                    "sensorDReading": "freezer_temperature"
                }
            }), 200
