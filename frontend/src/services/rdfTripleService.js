  ...
  createSensorMapping(predicates) {
    const sensorMapping = predicates
      ...
      .reduce((mapping, p) => {
        ...
        if (predicate.includes('oil_temperature')) {
        ...
        } else if (predicate.includes('water_temperature')) {
        ...
        } else if (predicate.includes('belt_speed')) {
        ...
        } else if (predicate.includes('freezer_temperature')) {
        ...
        } else if (predicate.includes('moisture_content')) {
        ...
        } else if (predicate.includes('product_weight')) {
  ...
  async getTelemetryWithSemanticMapping() {
    try {
      ...
      const enhancedTelemetry = telemetryResult.data.map(record => ({
        ...record,
        semantic: {
          componentUri: `http://example.com/potato-factory/component-${record.componentID}`,
